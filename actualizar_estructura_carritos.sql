...
CREATE TABLE USUARIOS (
    ...
    ROL VARCHAR2(20) CHECK (ROL IN ('CLIENTE', 'EMPRESA', 'DISTRIBUIDOR', 'BODEGUERO', 'ADMIN')),
...
CREATE TABLE CARRITOS (
    ...
    NOMBRE_CARRITO VARCHAR2(100) DEFAULT 'Carrito Principal', -- Nombre descriptivo del carrito
...
CREATE TABLE CARRITO_PRODUCTOS (
    ...
    CONSTRAINT FK_CARRITO_PRODUCTO_SUCURSAL FOREIGN KEY (ID_SUCURSAL) REFERENCES SUCURSALES(ID_SUCURSAL)
);
...
CREATE INDEX IDX_CARRITO_PRODUCTOS_FECHA ON CARRITO_PRODUCTOS(FECHA_AGREGADO);
