...
INSERT INTO USUARIOS (RUT, NOMBRE_COMPLETO, CORREO, CONTRASENA, DIRECCION, ROL) VALUES ('12345678-9', 'Juan Pérez', 'juan@example.com', 'pass123', 'Av. Las Condes 1234', 'CLIENTE');
INSERT INTO USUARIOS (RUT, NOMBRE_COMPLETO, CORREO, CONTRASENA, DIRECCION, ROL) VALUES ('98765432-1', 'María López', 'maria@example.com', 'pass456', 'Calle 5 Poniente 432', 'CLIENTE');
INSERT INTO USUARIOS (RUT, NOMBRE_COMPLETO, CORREO, CONTRASENA, DIRECCION, ROL) VALUES ('13579246-8', 'Carlos Soto', 'carlos@example.com', 'pass789', 'Pasaje 12 Sur 456', 'CLIENTE');
INSERT INTO USUARIOS (RUT, NOMBRE_COMPLETO, CORREO, CONTRASENA, DIRECCION, ROL) VALUES ('19283746-5', 'Fernanda Díaz', 'fernanda@example.com', 'pass321', 'Av. España 999', 'CLIENTE');
INSERT INTO USUARIOS (RUT, NOMBRE_COMPLETO, CORREO, CONTRASENA, DIRECCION, ROL) VALUES ('10293847-6', 'Ricardo Figueroa', 'ricardo@example.com', 'pass654', 'Los Pinos 321', 'CLIENTE');
INSERT INTO USUARIOS (RUT, NOMBRE_COMPLETO, CORREO, CONTRASENA, DIRECCION, ROL) VALUES ('56473829-1', 'Ana Torres', 'ana@example.com', 'pass987', 'Av. Vicuña Mackenna 890', 'CLIENTE');
INSERT INTO USUARIOS (RUT, NOMBRE_COMPLETO, CORREO, CONTRASENA, DIRECCION, ROL) VALUES ('29384756-3', 'Javier Morales', 'javier@example.com', 'pass159', 'Calle O’Higgins 789', 'CLIENTE');
INSERT INTO USUARIOS (RUT, NOMBRE_COMPLETO, CORREO, CONTRASENA, DIRECCION, ROL) VALUES ('18273645-0', 'Paula Rojas', 'paula@example.com', 'pass753', 'Camino Real 222', 'CLIENTE');
INSERT INTO USUARIOS (RUT, NOMBRE_COMPLETO, CORREO, CONTRASENA, DIRECCION, ROL) VALUES ('90817263-4', 'Martín Herrera', 'martin@example.com', 'pass852', 'Los Almendros 777', 'CLIENTE');
INSERT INTO USUARIOS (RUT, NOMBRE_COMPLETO, CORREO, CONTRASENA, DIRECCION, ROL) VALUES ('27483910-2', 'Isabel Núñez', 'isabel@example.com', 'pass963', 'Pje. Cordillera 333', 'CLIENTE');

INSERT INTO INVENTARIO (ID_SUCURSAL, ID_PRODUCTO, STOCK) VALUES (1, 101, 50);
INSERT INTO INVENTARIO (ID_SUCURSAL, ID_PRODUCTO, STOCK) VALUES (2, 101, 30);
INSERT INTO INVENTARIO (ID_SUCURSAL, ID_PRODUCTO, STOCK) VALUES (3, 102, 40);
INSERT INTO INVENTARIO (ID_SUCURSAL, ID_PRODUCTO, STOCK) VALUES (4, 102, 60);
INSERT INTO INVENTARIO (ID_SUCURSAL, ID_PRODUCTO, STOCK) VALUES (5, 103, 20);
INSERT INTO INVENTARIO (ID_SUCURSAL, ID_PRODUCTO, STOCK) VALUES (1, 103, 25);
INSERT INTO INVENTARIO (ID_SUCURSAL, ID_PRODUCTO, STOCK) VALUES (2, 104, 70);
INSERT INTO INVENTARIO (ID_SUCURSAL, ID_PRODUCTO, STOCK) VALUES (3, 104, 35);
INSERT INTO INVENTARIO (ID_SUCURSAL, ID_PRODUCTO, STOCK) VALUES (4, 106, 45);
COMMIT;
